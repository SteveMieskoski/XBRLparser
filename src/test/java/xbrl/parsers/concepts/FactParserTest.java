...
public class FactParserTest {
  ...
  //        @Ignore("FactParser.parse Test is ignored") //UnCommented when building other tests to
  // reduce noise
  @Test
  public void parse() {
    ...
    try {
      ...
      Document document =
          reader.read(new File("src/test/resources/testingFragments/abc-20161231.xml"));
